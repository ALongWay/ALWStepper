...
static NSString *const kImageAddDisable = @"ALWStepper.bundle/addDisable";
static NSString *const kImageAddNormal = @"ALWStepper.bundle/addNormal";
static NSString *const kImageMinusDisable = @"ALWStepper.bundle/minusDisable";
static NSString *const kImageMinusNormal = @"ALWStepper.bundle/minusNormal";
...
- (UIImage *)getImagePNGWithName:(NSString *)name;
{
    ...
    NSString *path = [bundle pathForResource:@"ALWStepperResource" ofType:@"bundle"];
    NSBundle *subBundle = [NSBundle bundleWithPath:path];
    
    NSString *filePath = [subBundle pathForResource:fullName ofType:@"png"];
